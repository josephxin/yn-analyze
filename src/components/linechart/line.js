  ...
  render() {
    ...
    return (
      <div className={'frame-style frame-size-time'} style={{ display: me.state.show }}>
        <div style={{
          width: (.8 * width - 16 + 36) / window._fontSize + 'rem',
          height: '1.2rem',
          position: "absolute",
          bottom: (.05 * height + 18 + 4) / window._fontSize + 'rem',
          left: (.07 * width + 32 - 25) / window._fontSize + 'rem',
      ...
      series: [
        {
          ...
          symbolSize: [15*scale, 15*scale],
          data: [100, 150, 120, 80, 100],
          markPoint: {
            symbolSize: [30*scale, 40*scale],
            symbolOffset: [0, "-50%"],
            data: [
              {
                type: 'max',
